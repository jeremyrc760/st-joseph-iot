...
describe('Telemetry E2E', () => {
  ...
  beforeAll(async () => {
    ...
    const moduleFixture: TestingModule = await Test.createTestingModule({
      ...
      controllers: [AuthController, TelemetryController],
  ...
  it('GET /telemetry/latest should reject a request without JWT', async () => {
    ...
    expect(telemetryServiceMock.findLatest).not.toHaveBeenCalled();
  });
  ...
  it('GET /telemetry/latest should allow an authenticated user', async () => {
    ...
    expect(response.body).toEqual(mockTelemetryRecords);
  });
